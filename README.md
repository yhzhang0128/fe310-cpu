...
2. Copy `earth.elf` and `disk.img` to the root directory of this repo
...
5. Open a shell and type `screen /dev/ttyUSB1 115200` to communicate with EGOS on Arty. If `screen` terminates directly, update permission by `sudo chmod 666 /dev/ttyUSB1`.
