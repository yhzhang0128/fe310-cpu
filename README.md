...
5. Open a shell and type `screen /dev/ttyUSB1 57600` to communicate with EGOS on Arty. If `screen` terminates directly, update permission by `sudo chmod 666 /dev/ttyUSB1`.
...
sudo apt-get install libtinfo5 # this one for Vivado
```
